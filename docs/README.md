...
- [02 - Architecture](device-control/02-architecture.md)
- [03 - Command Lifecycle](device-control/03-command-lifecycle.md)
- [04 - MQTT Publishing](device-control/04-mqtt-publishing.md)
- [05 - Feedback and Reconciliation](device-control/05-feedback-reconciliation.md)
...
- [02 - Architecture](automation/02-architecture.md)
- [03 - DAG Editor and Node Modals](automation/03-dag-editor-and-node-modals.md)
- [04 - Save, Validation, and Trigger Compilation](automation/04-save-validation-and-trigger-compilation.md)
- [05 - Runtime Trigger Matching and Execution](automation/05-runtime-trigger-matching-and-execution.md)
- [06 - Observability and Troubleshooting](automation/06-observability-and-troubleshooting.md)
- [07 - Operations and Performance](automation/07-operations-and-performance.md)
- [08 - Testing and Roadmap](automation/08-testing-and-roadmap.md)
